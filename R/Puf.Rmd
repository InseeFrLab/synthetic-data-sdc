...
Notre jeu de données est le puf au trimestre 1. Cherchons des filtres nous permettant de voir si la synthétisation de notre jeu de données s'est bien passée.
